...
def handle_request():
    ...
    if request.method == 'POST':
        ...
        cmd = ["C:\\Program Files\\FME\\fme.exe", "C:\\programs\\flask\\adressen\\adressen_binnen_wijk_export.fmw", "--WIJKEN_SELECT", wijk, "--EMAIL", email, "--COORDS", coords, "--TRANS_GARAGE", transformator_garagebox ]	
        print cmd
