    ...
    if request.method == 'POST':
        ...
        if not request.form.getlist('wijkenSelect'):
            if not coords:
                ...
                return render_template('fout_geen_wijk_geen_coords.html')
        ...
        cmd = ["C:\\Program Files\\FME\\fme.exe", "C:\\programs\\flask\\verblijfsobjecten\\verblijfsobjecten_binnen_wijk_export.fmw", "--WIJKEN_SELECT", wijk, "--EMAIL", email, "--COORDS", coords, "--GEBRUIK", gebruik, "--OUTPUT_TYPE", output ]
        ...
        # GET: create form
        return render_template( 'invoer_verblijfsobjecten.html', wijk=wijk, coords=coords, email=email)
