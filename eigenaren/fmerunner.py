...
def handle_request():
    ...
    if request.method == 'POST':
        ...
        cmd = ["C:\\Program Files\\FME\\fme.exe", "C:\\programs\\flask\\eigenaren\\eigenaren_binnen_wijk_export.fmw", "--WIJKEN_SELECT", wijk, "--EMAIL", email, "--COORDS", coords ]
        print cmd
        ...
        # GET: create form
        return render_template( 'woz_eigenaren_invoer.html', wijk=wijk, coords=coords, email=email)
