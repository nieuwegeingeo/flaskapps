...
def test():
    ...
    if request.method == 'POST':
        ...
        print out
        print err
        return render_template('test_resultaat.html', coords=coords, vbo_geb_functie=vbo_geb_functie, output_format=output_format, output_data=output_data, email=email )
    else:
        # GET: create form
        return render_template( 'test_invoer.html', coords=coords, vbo_geb_functie=vbo_geb_functie, output_format=output_format, output_data=output_data, email=email )
